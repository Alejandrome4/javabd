...
public class RecursoView {
    ...
    private HorarioView horarioView = new HorarioView(); // Para mostrar la disponibilidad
    ...
    private void listarConHorarios() {
        ...
        if (lista.isEmpty()) {
            ...
            for (Recurso r : lista) {
                ...
                horarioView.mostrarHorariosDeRecurso(r.getIdRecurso());
            }
            System.out.println("--------------------------------------------------");
        }
    }
    ...
    private void insertar() {
        ...
        try {
            ...
            // Se asume constructor: Recurso(nombre, descripcion, ubicacion, capacidad)
